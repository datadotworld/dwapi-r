...
dw_test_that("update_project making the correct HTTR request", {
  ...
  response <- with_mock(
    ...
    `mime::guess_type` = function(...)
      NULL,
    dwapi::update_project("ownerid/datasetid",
                          project_update_req = request)
  )
